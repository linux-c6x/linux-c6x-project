...
#CMDLINE = console=cio ip=dhcp root=/dev/nfs nfsroot=10.218.100.248:/opt/min-root-c6474-le rw
else
CMDLINE = console=cio ip=dhcp root=/dev/nfs nfsroot=158.218.100.25:/opt/min-root-c6x-be rw
#CMDLINE = console=cio ip=dhcp root=/dev/nfs nfsroot=10.218.100.248:/opt/min-root-c6474-be rw
endif
